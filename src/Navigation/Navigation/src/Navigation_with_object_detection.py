...
class field_Controller:
	...
	self.bridge = CvBridge()
        ...
        self.dummya_3 = rospy.Publisher("/Lane_change", Int16, queue_size=1)
    ...
    def obstacle_callback(self, data):
        ...
        curr_lane = 1
	switch = False
        for y in xrange(0,height,height//3):
          for x in xrange(0,width,width//3):
...
#mounted objects have closer range 
	...
	if switch:
        ...
        try:
	    self.Lane_cahange(Int16(self.lane))
            #self.dummya_3.publish(Int16(curr_lane))
        except CvBridgeError as e:
            print(e)
